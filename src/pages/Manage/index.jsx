...
const MiniMenu = () => {
  ...
  return (
    <Container 
      id="MiniMenuContainer" 
      fluid 
      style={{ backgroundImage: 'url("public/images/imagem.png")', minHeight: '100vh', padding: '2rem', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}
    >
      <Container 
